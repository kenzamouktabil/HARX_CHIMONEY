...
/**
 * This function initiates a transaction to a recipient's email address or mobile number
 * @param {string} receiver The email or phone number of the receiver
 * @param {string} currency The currency type (e.g., USD)
 * @param {number} amount The amount to transfer
 * @returns The response from the Chimoney API
 */
async function payoutChimoney(receiver, currency, amount) {
  ...
  console.log("Payload being sent to Chimoney API for payout:", payload);
